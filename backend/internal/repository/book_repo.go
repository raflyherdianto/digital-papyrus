...
`SELECT b.id, b.title, b.author, b.isbn, b.price, b.rating, b.review_count,
        b.description, b.synopsis, b.image_url, b.category_id, COALESCE(c.name, ''), b.status, b.stock,
...
&b.Description, &b.Synopsis, &b.ImageURL, &categoryID, &b.CategoryName, &b.Status, &b.Stock,
